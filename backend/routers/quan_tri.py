...
def danh_sach_nguoi_dung(vai_tro: Optional[str] = None, nguoi_dung=Depends(chi_quan_tri)):
    query = supabase.table("nguoi_dung").select("id, ho_ten, email, vai_tro, ten_lop, si_so, email_phu_huynh, dang_hoat_dong, ngay_tao, la_truong_khoi, khoi_phu_trach, khoi, gioi_tinh")
    if vai_tro:
